                    ...
                    <div style={{ backgroundImage: `url(${bg2})` }} className="md:w-[600px] lg:w-[600px] lg:h-[600px] mx-auto rounded-full p-2 md:p-5 lg:p-5">
                        ...
                        <div className="loginbg rounded-full p-[60px] w-full h-full">
                            ...
                            <form onSubmit={handleSubmit(onSubmit)} className="">
                                ...
                                <button type="submit" className="text-white primary hover:bg-purple-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center ">Submit</button><br /><br />
